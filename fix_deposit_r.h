...
------------------------------------------------------------------------- */
/*---<><><>-----------------------------------------------
 added capability described in fix_deposit.cpp
 new variables added to this file
 int nptypes - list of atom types from which to select
 int *type_list - pointer to list of atom types
...
class FixDeposit : public Fix {
 ...
 private:
  ...
  int nptypes; //---<><><>--- added nptypes to keep count of type_list
  int poly_flag; // ---<><><>--- set to cause type selection from type_list
  int *type_list;
...
Self-explanatory.
 ...
 ---<><><>--- added to allow poly_flag
E: Poly flag but no type list in fix deposit command
 
 Self-explanatory.
 
E: Illegal atom type in fix deposit type list
